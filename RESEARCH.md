# Lunar Phases MOTD
## Goal/Introduction
The primary goal of this program is to show ASCII art of the current lunar phase in my ubuntu server MOTD. It will also show the name of the phase below, and a countdown to when the next new/full moon is. Eventually I also want it to pull ISS location data from API and country name/coordinate data from different API to display which country ISS is above, and countdown to when it will be above Edmonton.
~~Also maybe Voyager 1/2 distances from earth.~~Not as interesting for scope of project. Could find someway to include voyager data in future  
...
## Research
### Questions
**Lunar phase is 29.5 days, whats a fixed historical date when a new moon occurred that I can always measure forward from**
