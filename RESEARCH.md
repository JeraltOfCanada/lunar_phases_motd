#Lunar Phases MOTD
##Goal/Introduction
The goal of this program is to show ASCII art of the current lunar phase in my ubuntu server MOTD. It will also show the name of the phase below, and a countdown to when the next new/full moon is. Pull ISS location data from API and country name/coordinate data from different API to display which country ISS is above, and countdown to when it will be above Edmonton.
